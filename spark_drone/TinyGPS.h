...
class TinyGPS
{
    ...
    static const float GPS_INVALID_F_ALTITUDE, GPS_INVALID_F_SPEED;
    ...
    void get_position(long *latitude,
        long *longitude, unsigned long *fix_age = 0);

    // date as ddmmyy, time as hhmmsscc, and age in milliseconds
    void get_datetime(unsigned long *date,
        unsigned long *time, unsigned long *age = 0);
    ...
    void crack_datetime(int *year, byte *month, byte *day,
        byte *hour, byte *minute, byte *second, byte *hundredths = 0,
        unsigned long *fix_age = 0);
    ...
    static float course_to (float lat1, float long1,
        float lat2, float long2);
